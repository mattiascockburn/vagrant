...
dpkg -i /tmp/puppetlabs-release-trusty.deb && rm /tmp/puppetlabs-release-trusty.deb
...
cp /vagrant/foreman-answers-demo.yaml /etc/foreman/foreman-installer-answers.yaml
foreman-installer
